...
#install mjpeg
sudo apt-get -y install libjpeg8-dev imagemagick libv4l-dev libav-tools
cd /home/pi
...
#download python
curl http://ec2-52-27-178-28.us-west-2.compute.amazonaws.com/pythonFiles/Motionhellohi2.py | python